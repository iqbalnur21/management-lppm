...
<form action="<?= site_url('pengabdian/' . $data['id_pengabdian']) ?>" method="post" autocomplete="off" enctype="multipart/form-data">
    ...
    <input type="hidden" name="user_id" id="user_id" class="form-control" value="<?= session('user_id') ?>">

    <div class="form-group">
        <label for="judul_pengabdian">Judul Pengabdian</label>
        <input type="text" name="judul_pengabdian" id="judul_pengabdian" class="form-control <?= isset(session('errors')['judul_pengabdian']) ? 'is-invalid' : '' ?>" value="<?= old('judul_pengabdian', $data['judul_pengabdian']) ?>" autofocus>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="tema" id="tema" class="form-control <?= isset(session('errors')['tema']) ? 'is-invalid' : '' ?>" value="<?= old('tema', $data['tema']) ?>">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="durasi" id="durasi" class="form-control <?= isset(session('errors')['durasi']) ? 'is-invalid' : '' ?>" value="<?= old('durasi', $data['durasi']) ?>">
    ...
    <div class="form-group">
        ...
        <textarea name="tujuan" id="tujuan" class="form-control <?= isset(session('errors')['tujuan']) ? 'is-invalid' : '' ?>" rows="2"><?= old('tujuan', $data['tujuan']) ?></textarea>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea name="catatan_verifikator" id="catatan_verifikator" class="form-control <?= isset(session('errors')['catatan_verifikator']) ? 'is-invalid' : '' ?>" rows="3"><?= old('catatan_verifikator', $data['catatan_verifikator']) ?></textarea>
                <div class="invalid-feedback">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="date" name="tanggal_pelaksanaan" id="tanggal_pelaksanaan" class="form-control <?= isset(session('errors')['tanggal_pelaksanaan']) ? 'is-invalid' : '' ?>" value="<?= old('tanggal_pelaksanaan', $data['tanggal_pelaksanaan']) ?>">
                <div class="invalid-feedback">
    ...
    <div class="form-group">
        <label for="file_surat_tugas">File Surat Tugas (PDF, DOCX)</label>
        <div class="custom-file">
            ...
            <label class="custom-file-label" for="file_surat_tugas">Pilih file (jika ingin mengganti)</label>

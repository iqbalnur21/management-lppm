...
<form action="<?= site_url('penelitian') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea name="catatan_verifikator" id="catatan_verifikator" rows="4" class="form-control <?= isset(session('errors')['catatan_verifikator']) ? 'is-invalid' : '' ?>"><?= old('catatan_verifikator') ?></textarea>
        <div class="invalid-feedback">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="date" name="tanggal_penelitian" id="tanggal_penelitian" class="form-control <?= isset(session('errors')['tanggal_penelitian']) ? 'is-invalid' : '' ?>" value="<?= old('tanggal_penelitian') ?>">
                <div class="invalid-feedback">

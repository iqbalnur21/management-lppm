...
class CreateLppmTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'status'             => ['type' => 'INT', 'constraint' => 11, 'unsigned' => true, 'comment' => '1 = terverifikasi, 2 = belum_terverifikasi'],
        ...
        $this->forge->addField([
            ...
            'status_surat'              => ['type' => 'INT', 'constraint' => 11, 'unsigned' => true, 'comment' => '1 = terverifikasi, 1 = belum_terverifikasi'],
